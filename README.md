...
* It should be available from the web site of the International Society for Mathematical Geology BUT IS IS NOT ! Look for v27-10-05.zip & v33-08-07.zip to LINKS TO PUBLISHED PROGRAMs CODE (https://www.iamg.org/iamg-publications/computers-geosciences/volumes.html ).  So, I uploaded it in GitHub. Readme.pdf and data (LiDAR DEM) are available for ver. 2
